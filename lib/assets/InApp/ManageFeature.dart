...
class Managefeature extends StatefulWidget {
  const Managefeature({super.key});

  @override
  State<Managefeature> createState() => _ManagefeatureState();
}

class _ManagefeatureState extends State<Managefeature> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.white, // Ensures background color is white
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pushNamed(context, '/createrestro');
                },
              ...
              child: Card(
                ...
                child: Container(
                  padding: const EdgeInsets.only(
                      left: 8.0, right: 8, bottom: 20, top: 20),
