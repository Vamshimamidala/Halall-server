...
class ManageRestaurantPage extends StatefulWidget {
  const ManageRestaurantPage({Key? key}) : super(key: key);
                ...
                children: [
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          _buildLabel('Restaurant Timings'),
                                ...
                                ...[
                                  ...
                                  return Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(vertical: 10.0), // Increased row height
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              // Day Column
                                              ...
                                              Expanded(
                                                child: Container(
                                                  height: 20.0, // Height of the white box
                                                  width: 60.0, // Width of the white box
                                                  decoration: BoxDecoration(
                                                    color: Colors.white,
                                                    borderRadius: BorderRadius.circular(3.8),
                                                  ),
                                                  child: TextField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      contentPadding: EdgeInsets.only(bottom: 14.0), // Add bottom padding to center text
                                                    ),
                                              ...
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: TextField(
                                                    controller: TextEditingController(text: '17:00'),
                                                    textAlign: TextAlign.center,
                                                    decoration: InputDecoration(
                                                      border: InputBorder.none, // Removes border
                                                      contentPadding: EdgeInsets.only(bottom: 14.0), // Add bottom padding to center text
                                              ...
                                              Expanded(
                                                child: Container(
                                                  height: 20.0, // Adjusted height for proper vertical centering
                                                  decoration: BoxDecoration(
                                                    color: Colors.white,
                                                    borderRadius: BorderRadius.circular(8.0),
                                                  ),
